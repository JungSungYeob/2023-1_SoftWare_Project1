...
public final class ActivityGalleryBinding implements ViewBinding {
  ...
  private ActivityGalleryBinding(@NonNull LinearLayoutCompat rootView,
      @NonNull FrameLayout contentLayout, @NonNull BottomNavigationView navView,
      @NonNull Toolbar toolbar, @NonNull Button uploadButton) {
  ...
  public static ActivityGalleryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGalleryBinding((LinearLayoutCompat) rootView, contentLayout, navView,
